...
sudo echo "`sudo blkid | grep Home | awk '{print $2}'` /home xfs defaults 0 0" >> /etc/fstab #вносим корректировки в файл fstab для монтирования вновь созданного каталога home в точке монтирования home
...
sudo mount /home #монтируем каталог home
